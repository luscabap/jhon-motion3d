...
export const BasePage = () => {
  ...
  return (
    <main className="font-fontMain min-h-screen bg-gradient-background transition-all duration-500 ease-in-out text-colorTextPrimary text-2xl ">
      <Header />
          ...
          <AnimatePresence>
            <motion.div>
              {modalContactIsOpen ? (
                ...
                <button
                  className="w-16 h-16 text-colorTextPrimary font-bold text-3xl flex justify-center items-center"
                  onClick={toggleModalContactIsOpen}
                >. . .</button>
              )}
            </motion.div>
